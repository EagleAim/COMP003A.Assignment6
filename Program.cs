...
namespace COMP003A.Assignment6
    {
       internal class Program
       {
            static void Main(string[] args)
            {
                ...
                // alternatively, you may use the syntax below, if for some reason yourarguments are not in the specific sequence
                // use the syntax below
                Vehicle vehicle4 = new Truck(truckNumberOfWheels: 4, truckBrand: "Ford",
                truckModel: "F-150 Raptor", sizeOfTruckBed: 5.5);
                vehicle4.GetInfo();
           }
